 ...
 */
public class RowValidationRuleTest extends RowValidationRule {
    ...
    public void callValidationFunctionTest() {
        try {
            Class<?> myClass = Class.forName(RowValidationRuleTest.class.getName());
            Method method = myClass.getMethod("dummyRowValidationFunction", ArchiveFile.class);
    ...
    public static ArchiveFileState dummyRowValidationFunction(ArchiveFile archiveFile) throws Exception {
    ...
    public void dynamicallyLoadMethodTest() {
        this.validationFunction = RowValidationRuleTest.class.getCanonicalName()
                +".dummyRowValidationFunction";
        try {
